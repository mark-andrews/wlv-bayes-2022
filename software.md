...
```r
devtools::install_github("mark-andrews/wlv-bayes-2022", subdir = "priorexposure")
```
...
```r
devtools::install_github("mark-andrews/wlv-bayes-2022", subdir = "priorexposure", upgrade = 'never')
```
